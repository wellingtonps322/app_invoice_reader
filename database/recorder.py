...
class Recorder(Database):
    ...
    def setInvoiceInformation(self, invoice):
        try:
            ...
            command = f'''
                        ...
                        VALUE ({invoice['id_invoice']}, {invoice['product']}, {invoice['country']}, {invoice['shipping_company']}, {invoice['mille']}, {invoice['period']}, {invoice['invoice_type']}, {invoice['invoice_status']});
                    '''
            ...
            print(e)
            print('ERROR: The invoice already inserted!')
    ...
    def setInvoicePayment(self, row_payment_dict: dict):
        ...
        command = f'''
                        ...
                        {row_payment_dict['service_type']}, {row_payment_dict['kms_range']}, {row_payment_dict['special_day']}, {row_payment_dict['part_time_route']}, 
                        {row_payment_dict['ambulance']}, {row_payment_dict['start_date']}, {row_payment_dict['end_date']}, {row_payment_dict['license_plate']}, 
    ...
    def setInvoiceDiscount(self, row_discount_dict: dict):
        ...
        command = f'''
                        ...
                        {row_discount_dict['discount_type']}, {row_discount_dict['id_complaint']}, {row_discount_dict['complaint_date']}, 
                        {row_discount_dict['license_plate_complaint']}, {row_discount_dict['start_date']}, {row_discount_dict['end_date']}, 
                        {row_discount_dict['license_plate']}, {row_discount_dict['driver']}, {row_discount_dict['quantity']}, {row_discount_dict['unit_price']}, 
    ...
    def setInvoiceAdditionalPayment(self, row_payment_dict: dict):
        ...
        command = f'''
                        ...
                        VALUES ({row_payment_dict['invoice']}, {row_payment_dict['id_route']}, {row_payment_dict['service_center']}, {row_payment_dict['data_type']}, 
                        {row_payment_dict['payment_type']}, {row_payment_dict['start_date']}, {row_payment_dict['end_date']}, {row_payment_dict['license_plate']}, 
                        {row_payment_dict['driver']}, {row_payment_dict['quantity']}, {row_payment_dict['unit_price']}, {row_payment_dict['total']});
                    '''
        self.cursor.execute(command)
        self.connection.commit()
    ...
    def setNewDriver(self, id_driver, driver_name, employee_sector, employee_function, service_center, license_plate, last_route):
        ...
        if id_driver != 'NULL' and service_center != 'NULL':
            ...
            command = f'''
                            ...
                            VALUES({id_driver}, {driver_name}, {employee_sector}, {employee_function}, "Ativo", {service_center},{license_plate}, {last_route});
                        '''
            if command:
                self.cursor.execute(command)
                self.connection.commit()
        ...
        if id_driver == 'NULL' and service_center != 'NULL':
            ...
            command = f'''
                            ...
                            VALUES({driver_name}, {employee_sector}, {employee_function}, {service_center},{license_plate}, {last_route});
                        '''
            if command:
                self.cursor.execute(command)
                self.connection.commit()
